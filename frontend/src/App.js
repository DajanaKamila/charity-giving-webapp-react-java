...
// import DonateDetailsPage from "./components/pages/create-donate/DonateDetailsPage";
// import DonateDetailsOrganism from "./components/organisms/create-donate/DonateDetailsOrganism"

import DonateDetailsPage from "./components/pages/create-donate/DonateDetailsPage.js"
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/home" element={userId && <HomePage  handleLogout={handleLogout}/>} >
            ...
            <Route path="donate/info/:fundraisingId" element={<DonateDetailsPage/>} />
          </Route>
